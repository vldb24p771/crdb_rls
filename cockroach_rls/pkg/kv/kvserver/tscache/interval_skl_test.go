...
func TestIntervalSklAdd(t *testing.T) {
	log.Infof(context.Background(), "TestIntervalSklAdd")
...
func TestIntervalSklSingleRange(t *testing.T) {
	log.Infof(context.Background(), "TestIntervalSklSingleRange")
...
func TestIntervalSklKeyBoundaries(t *testing.T) {
	log.Infof(context.Background(), "TestIntervalSklKeyBoundaries")
...
func TestIntervalSklSupersetRange(t *testing.T) {
	log.Infof(context.Background(), "TestIntervalSklSupersetRange")
...
func TestIntervalSklContiguousRanges(t *testing.T) {
	log.Infof(context.Background(), "TestIntervalSklContiguousRanges")
	ts1 := makeTS(201, 0)
...
func TestIntervalSklOverlappingRanges(t *testing.T) {
	log.Infof(context.Background(), "TestIntervalSklOverlappingRanges")
	val1 := makeVal(makeTS(200, 1), "1")
	val2 := makeVal(makeTS(201, 0), "2")
	val3 := makeVal(makeTS(300, 0), "3")
	val4 := makeVal(makeTS(400, 0), "4")
...
func TestIntervalSklSingleKeyRanges(t *testing.T) {
	log.Infof(context.Background(), "TestIntervalSklSingleKeyRanges")
...
func TestIntervalSklRatchetTxnIDs(t *testing.T) {
	log.Infof(context.Background(), "TestIntervalSklRatchetTxnIDs")
	ts1 := makeTS(100, 100)
	ts2 := makeTS(250, 50)
	ts3 := makeTS(350, 50)
...
func TestIntervalSklLookupRange(t *testing.T) {
	log.Infof(context.Background(), "TestIntervalSklLookupRange")
	ts1 := makeTS(100, 100)
	ts2 := makeTS(200, 201)
	ts3 := makeTS(300, 201)
	ts4 := makeTS(400, 201)
