...
for i in range(MAX_REGIONS):
    ...
    ssh_command = "docker run -t -d -v /home/ruijie/share/crdb/cockroach:/root/cockroach -v /home/ruijie/share/cockroach:/root/crdb_origin --cap-add NET_ADMIN --network " + NETWORK_NAME + " -p " + PORT1 + ":" + PORT1 + " -p " + PORT2 + ":" + PORT2 + " --name " + container_name + " --ip " + IP + " " + IMAGE_NAME + " /root/cockroach/crdb_scripts/tc_ssh.sh " + IP
    print(ssh_command)
